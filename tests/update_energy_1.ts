...
describe('Update energy', function () {
    ...
    describe('Check updateEnergy', function () {
        it('Check updateEnergy 1', async function () {
            ...
            expect(device.getCapabilityValue('meter_grid_today')).to.be.closeTo(1.5, 0.00001);
            expect(device.getCapabilityValue('meter_grid_yesterday')).to.be.closeTo(0, 0.00001);
            expect(device.getCapabilityValue('meter_grid_month')).to.be.closeTo(1.5, 0.00001);
            expect(device.getCapabilityValue('meter_grid_lastmonth')).to.be.closeTo(0, 0.00001);
            expect(device.getCapabilityValue('meter_grid_year')).to.be.closeTo(1.5, 0.00001);
            expect(device.getCapabilityValue('meter_cost_capacity')).eq(206);
            expect(device.getCapabilityValue('meter_consumption_hour')).eq(2000);
            expect(device.getCapabilityValue('meter_sum_current')).eq(4);
            expect(device.getCapabilityValue('meter_sum_day')).to.be.closeTo(6, 0.00001);
            expect(device.getCapabilityValue('meter_sum_month')).to.be.closeTo(6, 0.00001);
            expect(device.getCapabilityValue('meter_sum_year')).to.be.closeTo(6, 0.00001);
            ...
            expect(device.getCapabilityValue('meter_grid_today')).to.be.closeTo(12, 0.00001);
            expect(device.getCapabilityValue('meter_grid_yesterday')).to.be.closeTo(0, 0.00001);
            expect(device.getCapabilityValue('meter_grid_month')).to.be.closeTo(12, 0.00001);
            expect(device.getCapabilityValue('meter_grid_lastmonth')).to.be.closeTo(0, 0.00001);
            expect(device.getCapabilityValue('meter_grid_year')).to.be.closeTo(12, 0.00001);
            expect(device.getCapabilityValue('meter_cost_capacity')).eq(206);
            expect(device.getCapabilityValue('meter_consumption_hour')).eq(1000);
            expect(device.getCapabilityValue('meter_sum_current')).eq(2);
            expect(device.getCapabilityValue('meter_sum_day')).to.be.closeTo(48, 0.00001);
            expect(device.getCapabilityValue('meter_sum_month')).to.be.closeTo(48, 0.00001);
            expect(device.getCapabilityValue('meter_sum_year')).to.be.closeTo(48, 0.00001);
            expect(device.getCapabilityValue('meter_consumption_maxmonth')).eq(2000);
        });
    });
