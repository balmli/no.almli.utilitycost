...
describe('Update consumption', function () {
    ...
    describe('Check updateConsumption', function () {
        it('Check updateConsumption 1', async function () {
            ...
            expect(device.getCapabilityValue('meter_cost_capacity')).eq(125);
            ...
            */
            ...
            expect(device.getCapabilityValue('meter_grid_today')).to.be.closeTo(90, 0.00001);
            expect(device.getCapabilityValue('meter_grid_yesterday')).to.be.closeTo(180, 0.00001);
            expect(device.getCapabilityValue('meter_grid_month')).to.be.closeTo(90.5, 0.00001);
            expect(device.getCapabilityValue('meter_grid_lastmonth')).to.be.closeTo(0, 0.00001);
            expect(device.getCapabilityValue('meter_grid_year')).to.be.closeTo(90.5, 0.00001);
            expect(device.getCapabilityValue('meter_cost_capacity')).eq(638);
            expect(device.getCapabilityValue('meter_consumption_hour')).eq(15000);
            expect(device.getCapabilityValue('meter_sum_current')).eq(30);
            expect(device.getCapabilityValue('meter_sum_day')).to.be.closeTo(360, 0.00001);
            expect(device.getCapabilityValue('meter_sum_month')).to.be.closeTo(362, 0.00001);
            expect(device.getCapabilityValue('meter_sum_year')).to.be.closeTo(362, 0.00001);
    ...
    describe('Check updateConsumption', function () {
        it('Check updateConsumption 1', async function () {
            ...
            expect(device.getCapabilityValue('meter_grid_month')).to.be.closeTo(0, 0.00001);
            ...
            //console.log(device.getCapabilityValues());
            expect(device.getCapabilityValue('meter_grid_today')).eq(12);
            expect(device.getCapabilityValue('meter_grid_yesterday')).eq(0);
            expect(device.getCapabilityValue('meter_grid_month')).eq(12);
            expect(device.getCapabilityValue('meter_consumption_maxmonth')).eq(1000);

            await dh.updateConsumption(2000, '2022-07-02T00:00:00.000+02:00');
            //console.log(device.getCapabilityValues());
            expect(device.getCapabilityValue('meter_grid_today')).eq(0);
            expect(device.getCapabilityValue('meter_grid_yesterday')).eq(36);
            expect(device.getCapabilityValue('meter_grid_month')).eq(12);
            expect(device.getCapabilityValue('meter_consumption_maxmonth')).eq(1500);
            ...
            expect(device.getCapabilityValue('meter_grid_yesterday')).eq(36);
            expect(device.getCapabilityValue('meter_grid_month')).eq(36);
            expect(device.getCapabilityValue('meter_consumption_maxmonth')).eq(1500);
            ...
            //console.log(device.getCapabilityValues());
            expect(device.getCapabilityValue('meter_grid_today')).eq(72);
            expect(device.getCapabilityValue('meter_grid_yesterday')).eq(96);
            expect(device.getCapabilityValue('meter_grid_month')).eq(108);
            expect(device.getCapabilityValue('meter_consumption_maxmonth')).eq(3000);

            await dh.updateConsumption(9000, '2022-07-04T00:00:00.000+02:00');
            //console.log(device.getCapabilityValues());
            expect(device.getCapabilityValue('meter_grid_today')).eq(0);
            expect(device.getCapabilityValue('meter_grid_yesterday')).eq(180);
            expect(device.getCapabilityValue('meter_grid_month')).eq(108);
            ...
            expect(device.getCapabilityValue('meter_grid_yesterday')).eq(180);
            expect(device.getCapabilityValue('meter_grid_month')).eq(216);
            expect(device.getCapabilityValue('meter_consumption_maxmonth')).to.be.closeTo(5666.66666, 0.00001);
            ...
            expect(device.getCapabilityValue('meter_grid_today')).eq(108);
            expect(device.getCapabilityValue('meter_grid_yesterday')).eq(216);
            expect(device.getCapabilityValue('meter_grid_month')).eq(324);
            expect(device.getCapabilityValue('meter_consumption_maxmonth')).to.be.closeTo(8000, 0.00001);
            ...
            expect(device.getCapabilityValue('meter_grid_today')).eq(108);
            expect(device.getCapabilityValue('meter_grid_yesterday')).eq(216);
            expect(device.getCapabilityValue('meter_grid_month')).eq(432);
            expect(device.getCapabilityValue('meter_consumption_maxmonth')).to.be.closeTo(9000, 0.00001);
        });
    });
